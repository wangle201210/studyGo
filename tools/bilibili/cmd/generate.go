...
func main() {
	...
	db, _ := gorm.Open(mysql.Open("root:bilibili@(127.0.0.1:32444)/bilibili?charset=utf8mb4&parseTime=True&loc=Local"))
	g.UseDB(db)
	...
	g.ApplyBasic(g.GenerateModel("user"), g.GenerateModel("info"))
