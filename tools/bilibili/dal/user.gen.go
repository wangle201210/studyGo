...
func newUser(db *gorm.DB) user {
	...
	_user.Mid = field.NewInt32(tableName, "mid")
	_user.Name = field.NewString(tableName, "name")
	_user.Sex = field.NewString(tableName, "sex")
	_user.Face = field.NewString(tableName, "face")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Mid = field.NewInt32(table, "mid")
	u.Name = field.NewString(table, "name")
	u.Sex = field.NewString(table, "sex")
	u.Face = field.NewString(table, "face")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["id"] = u.ID
	u.fieldMap["mid"] = u.Mid
	u.fieldMap["name"] = u.Name
	u.fieldMap["sex"] = u.Sex
	u.fieldMap["face"] = u.Face
